...
On 4 June we will release a new single called `r track_name`, and would love to have it heard on `r radio_station`!   `r track_name` is an `r track_type` track about `r track_desc`. 
<br>
<br>
