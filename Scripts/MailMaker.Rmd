...
song <- read.csv(file = "C:/Users/Prime/Desktop/Toxic Bears Email Maker/data/Song_info.csv")
stations <- read.csv(file = "C:/Users/Prime/Desktop/Toxic Bears Email Maker/data/Station_info.csv")
song_subset <- song %>% 
...
We recently released a new single called `r track_name`, and would love to have it heard on `r radio_station`!   `r track_name` is an `r track_type` track about `r track_desc`.
<br>
<br>
...
You can also stream the track on YouTube from here:

`r YT_stream`
<br>
<br>

Alternatively, you can stream via your service of choice here:
